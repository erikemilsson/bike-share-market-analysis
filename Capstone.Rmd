...
### Missing values
We see some missing observations for some of the columns in the head. Using the skimr function gives more insight into how often they occur and for what columns.
```{r}
...
unique_start_station_name <- length(unique(df_1$start_station_name))
unique_start_station_id <-length(unique(df_1$start_station_id))
unique_start_station_lat <- length(unique(df_1$start_lat))
unique_start_station_lng <- length(unique(df_1$start_lng))
unique_end_station_name <- length(unique(df_1$end_station_name))
unique_end_station_id <- length(unique(df_1$end_station_id))
unique_end_station_lat <- length(unique(df_1$end_lat))
unique_end_station_lng <- length(unique(df_1$end_lng))
