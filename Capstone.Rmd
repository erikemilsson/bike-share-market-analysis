...
Now to inspect some values. There are missing observations for some of the columns in the head. Skimr gives more information about missing values and also unique values for each column.
```{r Information about missing and unique values}
skim_without_charts(df_renamed)
```

For the unique observations:
