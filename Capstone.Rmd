...
```
Docked bikes seem to be much more spread out than electric and classic bikes in travel time. This should be investigated further. There also appears to be one or more datapoints that are less than 0 for members using electric bikes. These points will be removed:
```{r}
df_nocoordinates3 <- df_nocoordinates2[df_nocoordinates2$Trip_Time_Minutes < 0, ] 
skim_without_charts(df_nocoordinates3)
```
To show off the statistical
