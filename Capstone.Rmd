...
paste("There are",unique_start_station_name, "unique start station names")
paste("There are",unique_start_station_id, "unique start station ids")
paste("There are",unique_start_station_lat, "unique start station latitudes")
paste("There are",unique_start_station_lng, "unique start station longitudes")

paste("There are",unique_end_station_name, "unique end station names")
paste("There are",unique_end_station_id, "unique end station ids")
paste("There are",unique_end_station_lat, "unique end station latitudes")
paste("There are",unique_end_station_lng, "unique end station longitudes")
